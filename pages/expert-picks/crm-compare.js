            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    >
                      <span>Pipedrive</span>
                      <div className="img">
                        <Image layout="fill" src="/img/pipedrive.png" alt="" />
                      </div>
                    </a>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <a
                      href="http://clickmetertracking.com/s22r"
                      target="_blank"
                      rel="noreferrer"
                      className="with__image"
                    >
                      <span>Clickup </span>
                      <div className="img">
                        <Image layout="fill" src="/img/clickup.png" alt="" />
                      </div>
                    </a>
                  </td>
                  <td>
                    <div className="rating__box">
                      <div className="rates">
                        <div className="shadow__rate">
                          ...
                          <i className="fa fa-star"></i>
                          <i className="fa fa-star"></i>
                          <div className="the__rate" style={{ width: "92%" }}>
                            {" "}
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                      ...
                      <a
                        href="https://www.spotsaas.com/product/clickup/reviews/"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <span>Read Review</span>
